...
import com.mapspeople.mapsindoorstemplatemapbox.databinding.FragmentDirectionStepBinding
import java.util.*
...
class DirectionStepFragment : Fragment() {
    ...
    private val mActionFileId = intArrayOf(
        ...
        R.drawable.ic_vec_sig_stairs,
        com.mapsindoors.coresdk.R.drawable.misdk_ic_ramp,
        com.mapsindoors.coresdk.R.drawable.misdk_ic_wheelchairlift,
        com.mapsindoors.coresdk.R.drawable.misdk_ic_wheelchairramp,
        com.mapsindoors.coresdk.R.drawable.misdk_ic_ladder
    )
